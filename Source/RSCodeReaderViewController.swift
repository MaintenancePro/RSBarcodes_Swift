...
open class RSCodeReaderViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    @objc open var targetMaskLayer = RSTargetMaskLayer()
    @objc open var targetLineLayer = RSTargetLineLayer()
    ...
    @objc open func roi(size: CGSize) -> CGRect {
        print(size)
    ...
    @objc open func roiPath(size: CGSize) -> CGPath {
   ...
   @objc func captureDevice() -> AVCaptureDevice? {
	...
	override open func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        self.output.rectOfInterest = self.videoPreviewLayer!.metadataOutputRectConverted(fromLayerRect: roi(size: size))
	}
    ...
    func avCaptureInputPortFormatDescriptionDidChangeNotification(notification: NSNotification) {
        ...
        self.output.rectOfInterest = self.videoPreviewLayer!.metadataOutputRectConverted(fromLayerRect: roi(size: UIScreen.main.bounds.size))
    }
